...
const pictures = document.getElementsByClassName("container");
  ...
  resetImgSize.addEventListener("click", function() {
   ...
   function changeImgSize(newSize) {
    // Source: https://alvarotrigo.com/blog/change-css-javascript/
    ...
    elementRules.style.setProperty('height', newSize);
    elementRules.style.setProperty('width', newSize);
  }
